...
type HelloRequest struct {
	...
	Name    string   `protobuf1:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` //1 是编号
	Age     int32    `protobuf1:"varint,2,opt,name=age,proto3" json:"age,omitempty"`
	Courses []string `protobuf1:"bytes,3,rep,name=courses,proto3" json:"courses,omitempty"`
}
...
var file_helloworld_proto_rawDesc = []byte{
	...
	0x03, 0x61, 0x67, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x73, 0x18,
	0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x73, 0x42, 0x0f,
