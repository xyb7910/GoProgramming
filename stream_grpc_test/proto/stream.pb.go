...
var file_stream_proto_rawDesc = []byte{
	...
	0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x22, 0x23, 0x0a, 0x0d, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52,
	...
	0x61, 0x6d, 0x52, 0x65, 0x71, 0x44, 0x61, 0x74, 0x61, 0x1a, 0x14, 0x2e, 0x68, 0x65, 0x6c, 0x6c,
	...
	0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71,
	0x44, 0x61, 0x74, 0x61, 0x1a, 0x14, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x53, 0x74, 0x72,
	0x65, 0x61, 0x6d, 0x52, 0x65, 0x73, 0x44, 0x61, 0x74, 0x61, 0x28, 0x01, 0x30, 0x01, 0x42, 0x0a,
...
var file_stream_proto_goTypes = []interface{}{
	(*StreamReqData)(nil), // 0: hello.StreamReqData
	(*StreamResData)(nil), // 1: hello.StreamResData
}
var file_stream_proto_depIdxs = []int32{
	0, // 0: hello.Greeter.GetStream:input_type -> hello.StreamReqData
	0, // 1: hello.Greeter.PutStream:input_type -> hello.StreamReqData
	0, // 2: hello.Greeter.AllStream:input_type -> hello.StreamReqData
	1, // 3: hello.Greeter.GetStream:output_type -> hello.StreamResData
	1, // 4: hello.Greeter.PutStream:output_type -> hello.StreamResData
	1, // 5: hello.Greeter.AllStream:output_type -> hello.StreamResData
...
func (c *greeterClient) GetStream(ctx context.Context, in *StreamReqData, opts ...grpc.CallOption) (Greeter_GetStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[0], "/hello.Greeter/GetStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) PutStream(ctx context.Context, opts ...grpc.CallOption) (Greeter_PutStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[1], "/hello.Greeter/PutStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) AllStream(ctx context.Context, opts ...grpc.CallOption) (Greeter_AllStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[2], "/hello.Greeter/AllStream", opts...)
	if err != nil {
		return nil, err
	}
